...
public class AnoncredsRevocationInteractionTest extends IndyIntegrationTestWithPoolAndSingleWallet {
	...
	public final static void main(String [] arg) throws Exception {
		AnoncredsRevocationInteractionTest test = new AnoncredsRevocationInteractionTest();
		
		test.createPoolAndWallet();
		
		test.createProverWallet();
		
		test.testAnoncredsRevocationInteractionIssuanceByDemand();
		
		test.deletePoolAndWallet();
		
		test.deleteWalletWallet();
...
/////////////////////////
		...
		blobStorageReaderHandle = BlobStorageReader.openReader(TYPE, tailsWriterConfig).get();
		int bStorageReaderHandle = blobStorageReaderHandle.getBlobStorageReaderHandle();
		String revStateJson = Anoncreds.createRevocationState(bStorageReaderHandle,
